...
NSString * const PLUGIN_CALENDAR_ESM_SCHEDULER_NOTIFICATION_CATEGORY = @"PLUGIN_CALENDAR_ESM_SCHEDULER_NOTIFICATION_CATEGORY";
NSString * const PLUGIN_CALENDAR_ESM_SCHEDULER_NOTIFICATION_ID = @"PLUGIN_CALENDAR_ESM_SCHEDULER_NOTIFICATION_ID";

NSString * const ACTION_AWARE_ESM_CANCEL = @"ACTION_AWARE_ESM_CANCEL";
NSString * const ACTION_AWARE_ESM_NEXT   = @"ACTION_AWARE_ESM_NEXT";
NSString * const ACTION_AWARE_ESM_DONE   = @"ACTION_AWARE_ESM_DONE";
NSString * const KEY_AWARE_ESM_CELLS     = @"KEY_AWARE_ESM_CELLS";
