...
extern NSString* const STATUS_SENSOR_BATTERY;
extern NSString* const STATUS_SENSOR_BLUETOOTH;
extern NSString* const STATUS_SENSOR_MAGNETOMETER;
extern NSString* const STATUS_SENSOR_ESMS;
extern NSString* const STATUS_SENSOR_GYROSCOPE;//Gyroscope
extern NSString* const STATUS_SENSOR_LOCATIONS;
extern NSString* const STATUS_SENSOR_NETWORK;
extern NSString* const STATUS_SENSOR_PROCESSOR;
extern NSString* const STATUS_SENSOR_PROXIMITY;
extern NSString* const STATUS_SENSOR_ROTATION;
extern NSString* const STATUS_SENSOR_SCREEN;
extern NSString* const STATUS_SENSOR_TELEPHONY;
extern NSString* const STATUS_SENSOR_WIFI;
extern NSString* const STATUS_SENSOR_GRAVITY;
extern NSString* const STATUS_SENSOR_LINEAR_ACCELEROMETER;
extern NSString* const STATUS_SENSOR_TIMEZONE;
extern NSString* const STATUS_SENSOR_AMBIENT_NOISE;
extern NSString* const STATUS_SENSOR_SCHEDULER;
extern NSString* const STATUS_SENSOR_CALLS;
extern NSString* const STATUS_SENSOR_LABELS;
...
extern NSString* const STATUS_SENSOR_GOOGLE_FUSED_LOCATION;
extern NSString* const STATUS_SENSOR_PLUGIN_OPEN_WEATHER;
extern NSString* const STATUS_SENSOR_PLUGIN_MSBAND;
extern NSString* const STATUS_SENSOR_PLUGIN_DEVICE_USAGE;
extern NSString* const STATUS_SENSOR_PLUGIN_NTPTIME;
extern NSString* const STATUS_SENSOR_PLUGIN_SCHEDULER;
extern NSString* const STATUS_SENSOR_PLUGIN_GOOGLE_CAL_PULL;
extern NSString* const STATUS_SENSOR_PLUGIN_GOOGLE_CAL_PUSH;
extern NSString* const STATUS_SENSOR_PLUGIN_GOOGLE_LOGIN;
extern NSString* const STATUS_SENSOR_PLUGIN_CAMPUS;
extern NSString* const STATUS_SENSOR_PLUGIN_PEDOMETER;
extern NSString* const STATUS_SENSOR_PLUGIN_WEB_ESM;
extern NSString* const STATUS_SENSOR_PLUGIN_BLE_HR;
extern NSString* const STATUS_SENSOR_AWARE_DEBUG;
extern NSString* const STATUS_SENSOR_PLUGIN_IOS_ESM;
extern NSString* const STATUS_SENSOR_PLUGIN_FITBIT;
extern NSString* const STATUS_SENSOR_PLUGIN_CONTACTS;
extern NSString* const STATUS_SENSOR_BASIC_SETTINGS;
